(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /home/moinadnan/Downloads/angular11-testapp/src/main.ts */
      "zUnb");
      /***/
    },
    ...
    /***/
    function Cy5W(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "sampleData", function () {
        return sampleData;
      });
      /**
       *Sample data
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      var _jsontreegriddata__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./jsontreegriddata */
      "Cy5W");
      /* harmony import */


      var _syncfusion_ej2_angular_treegrid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! @syncfusion/ej2-base */
      "4SUy");
      /* harmony import */
      ...
      var AppComponent = /*#__PURE__*/function () {
        ...
        _createClass(AppComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.dialog.hide(); // this.dialog.appendTo('#dialog');
            ...
            this.headermenuItems = [//Font size
            {
              text: "Font size"
            }, {
              text: "Text Wrap"
          ...
          value: function contextMenuOpen(arg) {
            ...
            return; // let row: Element | null = elem.closest('.e-row');
          ...
          value: function select(args) {
            ...
            var menu = document.getElementsByClassName("e-table"); // console.log(menu)
            // this.treegrid.addRecord();

            var rowid = this.treegrid.selectedRowIndex;
            this.selectitem = args.item.text; //var person = prompt("Please enter your name", "Harry Potter");

            if (args.item.text === 'Column Add') {
              var newcol = "";
              newcol = prompt("Please enter column name", "test");
              var newCols = [];
              this.treegrid.columns.forEach(function (res) {
              ...
              console.log(newCols); // old.push(added)
            ...
            if (args.item.text === 'Column Edit') {
              ...
              this.treegrid.columns.forEach(function (res) {
                ...
                if (_this.clickedColumn == res.headerText) {
                  newCols.push({
                    field: newcol,
                    headerText: newcol,
                    width: 70,
            ...
            if (args.item.text === 'Font size') {
              ...
              this.treegrid.columns.forEach(function (res) {
                ...
                if (_this.clickedColumn == res.headerText) {
                  targeted_col_index = i; // newCols.push({field: res.field, headerText:res.headerText, width: 70, textAlign: newcol});
                }
              ...
              console.log(newCols);
              var total_rows = this.treegrid.getRows().length; // alert(total_rows);

              for (var j = 0; j < total_rows; j++) {
                document.getElementsByClassName('e-rowcell')[targeted_col_index].style = "font-size: " + newcol + "px;";
                targeted_col_index = targeted_col_index + 5; // (document.getElementsByClassName('e-rowcell')[1] as any).style = "background-color: green";
              } // this.treegrid.columns = newCols;
            ...
            if (args.item.text === 'Column Delete') {
              ...
              this.treegrid.columns.forEach(function (res) {
                ...
                if (_this.clickedColumn == res.headerText) {// newCols.push({field: newcol, headerText:newcol, width: 70, textAlign: 'Right' });
                } else {
                  newCols.push({
                    field: res.field,
                    headerText: res.headerText,
            ...
            if (args.item.text === 'Add Next') {
              ...
              this.treegrid.addRecord(); // this.treegrid.;
            }

            if (args.item.text === 'Add Child') {
              var _selRow = this.treegrid.getSelectedRows(); //  alert(selRow.length)


              if (_selRow.length == 0 || _selRow.length < 0 || _selRow.length > 1) {
                alert("Please select a row first!");
                return;
              }

              var _temp = this.treegrid.dataSource;
              var count = parseInt(localStorage.getItem("lastcount")) + 1; //Math.floor(Math.random() * (9999 - 1004) + 1004);//temp.length+1;

              document.getElementById("_gridcontroltaskIDchild").value = count + "";
              localStorage.setItem("lastcount", count + "");
              this.dialog.show(); // this.editing = {  allowAdding: true, allowDeleting: true, allowEditing: true, mode: 'Row' , newRowPosition: 'Child' }; 
              // this.treegrid.addRecord();
              // this.treegrid.;
            }
            ...
            if (args.item.text === 'Edit Row') {
              ...
              this.treegrid.startEdit(selRow); // this.treegrid.updateRow(rowid,rowData);
            }
            ...
            if (args.item.text === 'Delete Row') {
              ...
              allselRows.forEach(function (rec) {
                // console.log(rec.ar)
                rec.remove(); // this.treegrid.deleteRow(rec)
            ...
            if (args.item.text === 'Enable Freeze') {
              var mvblColumns = this.treegrid.grid.getMovableColumns();
              ...
              var _targeted_col_index = 0;
              var _i = 0;
              this.treegrid.columns.forEach(function (res) {
                // console.log(res.field)
                if (_this.clickedColumn == res.headerText) {
                  _targeted_col_index = _i;
                }
              ...
              this.treegrid.columns.forEach(function (res) {
                // console.log(res.field)
                if (_j <= _targeted_col_index) {
                  _this.treegrid.grid.getColumnByField(res.field).freeze = "Left";
                }

                _j++;
              });
              setTimeout(function () {
                _this.treegrid.refreshColumns(); // this.treegrid.refresh();  

              }, 100);
            }

            if (args.item.text === 'TaskID' || args.item.text === 'Priority' || args.item.text === 'Approved' || args.item.text === 'StartDate' || args.item.text === 'TaskName') {
              ...
              var _mvblColumns = this.treegrid.grid.getMovableColumns();

              if (_mvblColumns.length === 1) {
                alert('Atleast one Column should be in movable');
                return;
              }
              ...
              setTimeout(function () {
                _this.treegrid.refreshColumns();
              }, 100);
            }

            if (args.item.text === 'Copy') {
              this.isCut = false; // navigator.clipboard.writeText("")

              var allselRows = this.treegrid.getSelectedRows(); // console.log(allselRows);

              this.treegrid.copy(); //  (document.getElementsByClassName('e-headercell')[1] as any).style.cssText = "";
            }

            if (args.item.text === 'Cut') {
              var allselRows = this.treegrid.getSelectedRows();
              this.isCut = true; // console.log(allselRows);

              this.treegrid.copy();
              allselRows.forEach(function (rec) {
                // console.log(rec)
                rec.remove(); // this.treegrid.deleteRow()
              });
              var _temp2 = this.treegrid.dataSource; // let rowid = this.treegrid.selectedRowIndex;
              // alert(rowid)

              var actualrow = this.treegrid.getRowInfo(this.treegrid.getRowByIndex(rowid));
              actualrow = actualrow.rowData;

              var actualindex = _temp2.findIndex(function (item) {
              ...
              _temp2.splice(actualindex, 1);

              this.treegrid.dataSource = _temp2; // console.log(temp);
              // console.log(this.treegrid.dataSource);

              this.treegrid.refresh(); // this.treegrid.remove
            ...
            if (args.item.text === 'PasteNext') {
              ...
              navigator.clipboard.readText().then(function (text) {
                ...
                _this.treegrid.dataSource = temp;

                _this.treegrid.refresh(); // console.log(this.treegrid.dataSource)
          ...
          key: "traverse",
          value: function traverse(obj, taskID, newChild) {
            if (obj.subtasks) {
              var o = obj.subtasks;
          ...
          value: function saveChild() {
            ...
            if (actualrow.rowData.hasChildRecords && actualrow.rowData.level == 0) {
              ...
              //complex case
              var actualindex = rowid; // alert('{"taskID":'+actualrow.rowData.taskID);

              temp.forEach(function (rec, ind) {
              ...
              this.traverse(temp[actualindex], actualrow.rowData.taskID, obj); // temp[actualindex]
            } else {
              actualrow = actualrow.rowData;

              var _actualindex = temp.findIndex(function (item) {
                // console.log(item.taskID +"=="+ actualrow.taskID)
                return item.taskID == actualrow.taskID;
              }); // alert(actualindex);


              temp[_actualindex] = Object.assign(Object.assign({}, temp[_actualindex]), {
                subtasks: [obj]
              });
      ...
      AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
        ...
        template: function AppComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("select", function AppComponent_Template_ejs_contextmenu_select_20_listener($event) {
              return ctx.select($event);
            })("beforeOpen", function AppComponent_Template_ejs_contextmenu_beforeOpen_20_listener($event) {
              return ctx.contextMenuOpen($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("select", function AppComponent_Template_ejs_contextmenu_select_23_listener($event) {
              return ctx.select($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AppComponent_Template_button_click_68_listener() {
              return ctx.saveChild();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function AppComponent_Template_button_click_70_listener() {
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var _syncfusion_ej2_angular_dropdowns__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! @syncfusion/ej2-angular-dropdowns */
      "jcQU");
      /* harmony import */


      var _syncfusion_ej2_angular_treegrid__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! @syncfusion/ej2-angular-treegrid */
      "QUNt");
      /* harmony import */
      ...
      /*! @angular/core */
      "fXoL"); // import {DragDropModule} from '@angular/cdk/drag-drop';
      ...
      AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineInjector"]({
        providers: [_syncfusion_ej2_angular_treegrid__WEBPACK_IMPORTED_MODULE_5__["FilterService"], _syncfusion_ej2_angular_treegrid__WEBPACK_IMPORTED_MODULE_5__["PageService"], _syncfusion_ej2_angular_treegrid__WEBPACK_IMPORTED_MODULE_5__["SortService"], _syncfusion_ej2_angular_treegrid__WEBPACK_IMPORTED_MODULE_5__["ResizeService"], _syncfusion_ej2_angular_treegrid__WEBPACK_IMPORTED_MODULE_5__["ColumnMenuService"], _syncfusion_ej2_angular_treegrid__WEBPACK_IMPORTED_MODULE_5__["ReorderService"], _syncfusion_ej2_angular_treegrid__WEBPACK_IMPORTED_MODULE_5__["ContextMenuService"]],
        imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _syncfusion_ej2_angular_treegrid__WEBPACK_IMPORTED_MODULE_5__["TreeGridModule"], _syncfusion_ej2_angular_dropdowns__WEBPACK_IMPORTED_MODULE_4__["DropDownListModule"], _syncfusion_ej2_angular_navigations__WEBPACK_IMPORTED_MODULE_1__["ContextMenuModule"]]]
      });
